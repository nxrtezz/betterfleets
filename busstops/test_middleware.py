...
from .middleware import SITE_USAGE_COOKIE, get_site_usage_entries
...
class MiddlewareTest(TestCase):
    ...
    def test_site_usage_tracking_sets_cookie_and_cache_entry(self):
        response = self.client.get("/")

        self.assertIn(SITE_USAGE_COOKIE, response.cookies)
        usage = get_site_usage_entries()
