...
class Migration(migrations.Migration):
    ...
    operations = [
        # This migration is now using conditional SQL to handle existing columns
        # The model fields are already in the database from previous migrations
        # or manual schema changes
        migrations.RunSQL(
            """
            DO $$
            BEGIN
