...
_SIRI_NS = bods_parser.SIRI_NS
_elem_to_dict = bods_parser.elem_to_dict
...
class Command(ImportLiveVehiclesCommand):
    ...
    def get_vehicle_identity(item):
        return matcher.get_vehicle_identity(item)

    @staticmethod
    def get_journey_identity(item):
        return matcher.get_journey_identity(item)

    @staticmethod
    def get_item_identity(item):
        return matcher.get_item_identity(item)
